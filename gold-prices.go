...
type Price struct {
	...
	Price         float64   `json:"xauPrice,omitempty"`
...
func (g *Gold) GetPrices() (*Price, error) {
	...
	if err != nil {
		log.Println("error cannot read from goldprice.org", err)
		return nil, err
	}
	...
	if err != nil {
		log.Println("error unmarshal failed", err)
		return nil, err
	}
